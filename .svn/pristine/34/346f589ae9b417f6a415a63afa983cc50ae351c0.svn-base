...
class Main {
	...
	static public var menuContainer:HTMLDivElement;
	...
	static function main() {
		...
		//Main.log("Agent: " + Lib.window.navigator.userAgent);
	...
	static public function initGame(canvas_:HTMLCanvasElement, container_:HTMLDivElement):Void {
		...
		menuContainer = untyped Lib.document.getElementById('menuContainer');
		menuContainer.setAttribute('style','opacity:0.75');
		menuContainer.style.display = 'none';
		menuContainer.style.position = 'absolute';
		menuContainer.style.padding = '10px';
		menuContainer.style.backgroundColor = '#FFF';
		menuContainer.style.font = '14px Font2';
		menuContainer.style.color = '#000000';
		menuContainer.style.border = '1px solid #FFF';
