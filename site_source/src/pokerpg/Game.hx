...
class Game {
	...
	static public function loadMap(id:String, chars:Array<CCharacterData>):Void {
		...
		if (!loadedBasicUI) {
			...
			// Battle
			loadImageResource('battlePokemonBar', 'resources/battle/ui/battle_pokemon_bar.png');
			loadImageResource('battleHealthBar', 'resources/battle/ui/battle_healthbar.png');
			loadImageResource('battleEnemyBar', 'resources/battle/ui/battle_enemy_bar.png');
			loadImageResource('battleMisc', 'resources/battle/ui/battle_misc.png');
			loadImageResource('battleTrainerStatus', 'resources/battle/ui/battle_trainer_status.png');
			loadImageResource('battleMoveMenu', 'resources/battle/ui/battle_move_menu.png');
			loadImageResource('battleTextBackground', 'resources/battle/ui/battle_box.png');
			loadImageResource('battleActionMenu', 'resources/battle/ui/battle_action_menu.png');
