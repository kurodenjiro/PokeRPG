...
class PokemonConst {
	...
	static public function getNatureName(id:Int):String {
		switch(id) {
			...
			case 5: return "Bold";
			case 6: return "Impish";
			case 7: return "Lax";
			case 8: return "Relaxed";
			
			case 9: return "Modest";
			case 10: return "Mild";
			case 11: return "Rash";
			case 12: return "Quiet";
			
			case 13: return "Calm";
			case 14: return "Gentle";
			case 15: return "Careful";
			case 16: return "Sassy";
			
			case 17: return "Timid";
			case 18: return "Haste";
			case 19: return "Jolly";
			case 20: return "Naive";
			
			case 21: return "Hardy";
			case 22: return "Docile";
			case 23: return "Serious";
			case 24: return "Bashful";
			case 25: return "Quirky";
		}
		throw "Unknown nature id: "+id;
	}
	
	static public function getNatureDescription(id:Int):String {
		switch(id) {
			case 1: return "Lonely";
			case 2: return "Adamant";
			case 3: return "Naughty";
...
typedef PokemonOwned = {
	...
	public var icon2:ImageResource;
	public var iconBig:ImageResource;
	public var iconBig2:ImageResource;
}
